...
Usage examples:
  ...
  python get_width_from_photos.py --folder photos --config config/data_collection.yaml --output results.csv
    ...
    parser.add_argument('--folder', type=str, default='/home/rvsa/codehub/VB-vla/photos',
                       help='Folder path containing photos')
    parser.add_argument('--config', type=str, default='/home/rvsa/codehub/VB-vla/Data_collection/config/config.yaml',
