...
def compute_relative_pose(pos, rot, base_pos, base_rot_mat,   # TODO: Not used by us, not processed
...
def convert_pose_mat_rep(pose_mat, base_pose_mat, pose_rep='abs', backward=False):
    if not backward:
        ...
        if pose_rep == 'abs':
            ...
            out[...,:3,3] = pos
            return out
        elif pose_rep == 'relative': # WE ARE USING THIS ONE
            # print(base_pose_mat.shape)
            out = base_pose_mat @ pose_mat   # (16, 4, 4） @ （4， 4）
